...
/**
 * Action para carregar a lista de ferramentas e seus devidos status.
 *
 * @param {*} appList - array de ferramentas cadastradas com nomes e status para checarem/redirecionamento quando em manutenção.
 */
export const updateAppsStatus = (appList = []) => ({
  type: types.UPDATE_APPS_STATUS,
  payload: appList,
});
