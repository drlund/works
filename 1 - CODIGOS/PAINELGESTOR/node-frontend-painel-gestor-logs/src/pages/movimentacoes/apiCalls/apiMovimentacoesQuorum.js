...
export const postQuorumMeuPrefixo = async (quorum, observacao) => fetch(FETCH_METHODS.POST, 'movimentacoes/excessoes-quorum-proprio', {
  quorum,
  observacao
}).then(() => message.success('Quorum criado com sucesso!'));

export const patchQuorumMeuPrefixo = async (quorum, observacao) => fetch(FETCH_METHODS.PATCH, 'movimentacoes/excessoes-quorum-proprio', {
  quorum,
  observacao
...
export const postQuorumQualquerPrefixo = async ({ prefixo, quorum, observacao }) => fetch(FETCH_METHODS.POST, 'movimentacoes/excessoes-quorum-qualquer', {
  prefixo,
  quorum,
  observacao,
}).then(() => message.success('Quorum criado com sucesso!'));

export const patchQuorumQualquerPrefixo = async ({ prefixo, quorum, observacao }) => fetch(FETCH_METHODS.PATCH, 'movimentacoes/excessoes-quorum-qualquer', {
  prefixo,
  quorum,
  observacao,
}).then(() => message.success('Quorum alterado com sucesso!'));
