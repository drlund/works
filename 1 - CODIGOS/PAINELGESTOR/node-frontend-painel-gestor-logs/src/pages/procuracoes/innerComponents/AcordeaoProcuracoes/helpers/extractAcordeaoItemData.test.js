        ...
        expect(tableDataSource).toEqual([
          {
            ...
            revogacao: procuracao0.procuracaoAgregada.revogacao,
            acoes: [
              { 'Baixar Procuração': procuracao0.procuracaoAgregada.doc }
            ],
            raw: procuracao0,
          }
        ]);
        ...
        expect(tableDataSource).toEqual([
          {
            ...
            matricula: procuracao0.outorgado.matricula,
            cargo: procuracao0.outorgado.cargo,
            procuracaoAtiva: Number(procuracao0.subsidiarias.every(s => s.subAtivo === 1)),
            ...
            revogacao: procuracao0.subsidiarias[0].revogacao,
        ...
        expect(tableDataSource).toEqual([
          {
            ...
            nome: procuracao0.outorgado.nome,
            procuracaoAtiva: procuracao0.procuracaoAgregada.procuracaoAtiva,
            matricula: procuracao0.outorgado.matricula,
            cargo: procuracao0.outorgado.cargo,
            manifesto: procuracao0.procuracaoAgregada.manifesto,
            procuracaoId: procuracao0.procuracaoAgregada.procuracaoId,
          ...
          },
          {
            ...
            procuracaoAtiva: Number(procuracao1.subsidiarias.every(s => s.subAtivo === 1)),
            ...
            revogacao: procuracao1.subsidiarias[0].revogacao,
