                ...
                <tr style="height: 26px;">
                  <td style="width: 100%; height: 26px;" colspan="2">
                    <span style="font-family: helvetica, sans-serif;">
                      Houve uma alteração nas <strong>instruções normativas</strong> desta ordem e é necessária uma nova assinatura sua 
                      como <strong>Designante</strong> para que a mesma entre em vigência. <br />
