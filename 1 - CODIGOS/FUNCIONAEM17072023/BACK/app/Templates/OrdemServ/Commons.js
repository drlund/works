const { base64Logo } = use('App/Templates/OrdemServ/LogoBBBase64');
...
module.exports = {
  renderHeader: (bgHeader) => {
    ...
    <div style="width:80%; margin: 0 auto; top: 20px; background-color: ${bgHeader}; height: 70px; 
        ...
        <div style="color: #fff; font-weight: bold; font-size: 22px; padding: 23px 0 0 20px;">Ordem de Serviço</div>
    </div>`;    
  },
        ...
        <tbody>
          <tr style="">
            ...
            <td style="vertical-align: top;">
              <div style="color: #565656; font-weight: bold; font-size: 20px;padding: 44px 0 0 0px;">Ferramenta de Ordem de Serviço</div>
