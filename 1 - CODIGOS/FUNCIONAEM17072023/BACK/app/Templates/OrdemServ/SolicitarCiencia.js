const Env = use('Env');
const SIGN_URL = Env.get('FRONTEND_URL') + "ordemserv/dar-ciencia-ordem";
            ...
            <table style="border-collapse: collapse; width:95%; margin: 0 auto; color: #565656; border:none;" border="0">
              <tbody>
                ...
                <tr style="height: 26px;">
                  <td style="width: 100%; height: 26px;" colspan="2"><span style="font-family: helvetica, sans-serif;">Voc&ecirc; foi inclu&iacute;do(a) como <strong>Designado</strong> na Ordem de Servi&ccedil;o abaixo:</span></td>
                </tr>
              </tbody>
            </table>  
          </td>
              ...
              <tbody style="font-family: helvetica, sans-serif;">
                <tr style="height: 43px;">
                  <td style="width: 100%; height: 43px; padding-left:4px;" colspan="2">
                    <span>Verifique os dados completos desta O.S e realize a ciência desta ordem <a href="${SIGN_URL}/{5}" target="_blank" rel="noopener noreferrer">clicando aqui.</a></span>
                  </td>
                </tr>
              </tbody>
            </table>  
