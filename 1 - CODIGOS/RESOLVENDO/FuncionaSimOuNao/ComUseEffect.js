...
function FormParamAlcadas({ location }) {
  ...
  function handleChangeComite(value) {
    setComite(value);
  }
  ...
  function handleComissaoDestinoChange(value) {
    ...
    if (selectedOption) {
      ...
      form.setFieldsValue({comite: gravaParametros.comite});
      form.setFieldsValue({nomeComite: gravaParametros.nomeComite});
    } else {
      ...
      <Card>
        ...
        >
          ...
          >
            ...
            />
            {temComite && (
              <span style={{ color: 'green' }}>O prefixo possui comitê.</span>
            )}
          </Form.Item>
