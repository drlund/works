//Aqui está o código com as alterações sugeridas para o mapeamento dos valores da tabela nos valores do "Radio.Group":

/**
 * Neste código, as alterações foram feitas na parte em que o componente "Radio.Group" é renderizado, onde os valores nos 
 * elementos "Radio" foram trocados pelos valores correspondentes às chaves no objeto "tipoJurisdicoesMap". Essa alteração 
 * permitirá que os valores sejam corretamente mapeados quando o usuário selecionar uma opção. Os demais detalhes do código 
