...
export default function ListaCanais() {
  ...
  const columns = [
    ...
    // TODO: não implementada funcionalidade de seguir canal
    // {
    //   title: 'Seguidores',
    ...
    // },
    {
      ...
      width: '12%',
      render: (matriculaResponsavel) => <a href={`https://humanograma.intranet.bb.com.br/${matriculaResponsavel.toUpperCase()}`} target="_blank" rel="noreferrer">{matriculaResponsavel.toUpperCase()}</a>,
    },
    {
      title: 'Ações',
      width: '10%',
