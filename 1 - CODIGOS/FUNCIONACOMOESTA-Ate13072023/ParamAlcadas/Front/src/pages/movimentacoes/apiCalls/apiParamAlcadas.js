...
export const verificarStatusParametro = async (
  /** @type {string} */ prefixoDestino,
  /** @type {string} */ comissaoDestino,
) =>
  fetch(FETCH_METHODS.GET, '/movimentacoes/verificarStatusParametro/', {
    prefixoDestino,
    comissaoDestino,
  });
export const atualizarStatusParametro = async (
  /** @type {string} */ prefixoDestino,
  /** @type {string} */ comissaoDestino,
) =>
  fetch(FETCH_METHODS.GET, '/movimentacoes/atualizarStatusParametro/', {
    prefixoDestino,
    comissaoDestino,
  });
