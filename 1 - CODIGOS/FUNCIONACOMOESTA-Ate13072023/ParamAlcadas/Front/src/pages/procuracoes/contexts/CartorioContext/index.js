 ...
 * @typedef {{lista: Cartorio[]; reload: () => void; shouldLoading: boolean;}} CartorioContext
 */

const Cartorios = createContext(/** @type {CartorioContext} */(null));

export function CartorioContext(/** @type {{ children: import('react').ReactNode}} */ { children }) {
  const [listaCartorios, setListaCartorios] = useState(/** @type {Cartorio[]} */(null));
