...
Route.group( () => {  
  ...
  Route.get('/verificarStatusParametro', 'Movimentacoes/ParametrosAlcadasController.verificarStatusParametro');
  Route.get('/atualizarStatusParametro', 'Movimentacoes/ParametrosAlcadasController.atualizarStatusParametro');
})
